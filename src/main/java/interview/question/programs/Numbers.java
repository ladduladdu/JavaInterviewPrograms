...

{
	...
	/*	int value=1;
		...
		for (int i = 1; i <=4; i++) {// to check factorial
			value=value*i;
		}
		System.out.println(value);*/
		
		/*int n=2;
		for (int i = 5; i <=10; i++) {//printing multipliction table
			for (int j = 1; j <=10; j++) {
	...
	/*	int rev=0;
		...
		while(n>0)//printing revrse integer
		{
			x=n%10;
			rev=rev*10+x;
			n=n/10;
	...
	}else
	{
		...
		b=25;
		c=5;
		abc=(a>b)?(a>c?a:c):(a>b?a:b);// ternary shorthand for if then else statement
		
		System.out.println(abc);*/
		
		
/*int n,a;//printing number length
n=1000;
a=0;
...
System.out.println(a);*/
		...
		/*int n=1000;
		int s=String.valueOf(n).length();// printing number length
		System.out.println(s);*/
		
		//replacing the word whose number multiply with 3 & 5 	
	/*	for (int i = 1; i <=20; i++) {	
			if (i%(3*5)==0) {		
				System.out.println("ar35");
			} else if(i%3==0){
